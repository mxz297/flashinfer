...
def get_fp4_quantization_module(backend: str = "100"):
    ...
    def nvfp4_quant_and_per_token_scale_sm100(
        ...
        output_scale = input.new_empty((out_scale_rows, out_scale_cols), dtype=torch.uint8)
...
def nvfp4_quant_and_per_token_scale(
    ...
    *,
    ...
    major, minor = get_compute_capability(input.device)
    device_arch = f"{major * 10 + minor}"
    return get_fp4_quantization_module(device_arch).nvfp4_quant_and_per_token_scale_sm100(
        input,
        scale_inv,
        expanded_idx_to_permuted_idx,
        sf_layout.value,
